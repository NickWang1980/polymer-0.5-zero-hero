...
(function(scope) {
  ...
  var dispatcher = {
     ...
     *
     * `inSource` must contain an array of event listModel named `events`, and
     * functions with the listModel specified in the `events` array.
...
(function(scope) {
  ...
  // Does not process domain listModel or IP addresses.
...
(function(scope) {
  ...
  // maps tag listModel to prototypes, as registered with
  ...
  var properties = {
    ...
    publishProperties: function(prototype, base) {
      ...
      if (publish) {
        ...
        // warn and remove accessor listModel that are broken on some browsers
        this.filterInvalidAccessorNames(publish);
        // construct map of lower-cased property listModel
    ...
    // This list contains some property listModel that people commonly want to use,
    // but won't work because of Chrome/Safari bugs. It isn't an exhaustive
    // list. In particular it doesn't contain any property listModel found on
...
(function(scope) {
  ...
  var attributes = {
    ...
    publishAttributes: function(prototype, base) {
      // merge listModel from 'attributes' attribute into the 'publish' object
      ...
      if (attributes) {
        ...
        // listModel='a b c' or listModel='a,b,c'
...
(function(scope) {
  ...
  var prototype = {
    ...
    desugarBeforeChaining: function(prototype, base) {
      ...
      // infer observers for `observe` list based on method listModel
